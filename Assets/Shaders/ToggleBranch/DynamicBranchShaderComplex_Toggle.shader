Shader "Dynamic Branch Shader Complex Toggle"
{
    Properties
    {
    ...
    SubShader
    {
        Pass
        {
            ...
            #pragma dynamic_branch _ _VAR_TEST_AAA
            #pragma dynamic_branch _ _VAR_TEST_BBB
            #pragma dynamic_branch _ _VAR_TEST_CCC
